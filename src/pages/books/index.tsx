...
function BookListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<BookInterface[]>(
    ...
    () =>
      getBooks({
        relations: ['organization', 'user', 'bookmark.count', 'highlight.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('highlight', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>highlight</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
